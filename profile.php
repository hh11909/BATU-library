      ...
      <div class="col-lg-7 p-0 p-md-0 m-0  z-0 ">
        <div class="profile-content ">
          ...
          <div class=" position-relative ">
            ...
            <img src="" alt="" class="profile-big-picture d-block container-fluid p-0"
              id="BigImageDisplay">
        ...
        <div class="profile-borrowed-section ">
          ...
          <div class="text-end p-4">
            <a href="borrowed.php" class="show-more text-decoration-underline">Show More</a>
          </div>
        ...
        <div class="book-recommend-section mb-5">
          ...
          <div class="text-end p-4">
            <a href="Explore.php" class="show-more text-decoration-underline"><h6>Show More</h6></a>
          </div>
