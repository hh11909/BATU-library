...
<div class="container">
    <div class="register-container">
            ...
            <div>
              ...
              <div class="input-container">
                <input
                  ...
                  required
                />
                <span class="togglePassword"  id="togglePassword" onclick="toggleIcon(this.previousElementSibling,this.children[0],this.children[1])">
        ...
        <p class="text-center mt-3">If you have don't an account <a href="register1.php" class="login">Register Now!</a></p>
    </div>
    </div>
</div>
<!-- Footer -->
