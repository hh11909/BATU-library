    ...
    <nav class="navbar navbar-expand-lg navbar-dark custom-navbar fixed-top p-1">
        <div class="container">
            <a class="navbar-brand fs-4" href="#">
                <img src="images/logo.png" alt="Logo" width="40" height="40" class="d-inline-block align-text-top me-2 admin-logo">
                BATU Library Admin
            </a>
            <button class="navbar-toggler shadow-none" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasAdminNavbar" aria-controls="offcanvasAdminNavbar" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
            <div class="sidebar offcanvas offcanvas-end" tabindex="-1" id="offcanvasAdminNavbar" aria-labelledby="offcanvasAdminNavbarLabel">
                <div class="offcanvas-header text-white border-bottom">
                    <h5 class="offcanvas-title" id="offcanvasAdminNavbarLabel">Admin Menu</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                </div>
                <div class="offcanvas-body d-flex flex-column flex-lg-row p-lg-0 p-4">
                    <ul class="navbar-nav ms-auto justify-content-lg-end align-items-center fs-6 flex-grow-1 pe-3">
            ...
            <div class="row justify-content-around">
                <div class="col-lg-3 col-md-6 mb-4 mb-lg-0 footer-col">
                    <div class="d-flex align-items-center mb-2 footer-logo-group">
                        <img src="images/logo.png" alt="Logo" width="35" height="35" class="me-2 admin-logo">
