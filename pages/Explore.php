      ...
      <div class="offcanvas-body">
        <div class="row gx-2 gy-3">
          ...
          <div class="col-md-6 col-lg-3 mb-2">
            ...
            <div class="d-flex flex-wrap gap-2">
              <button id='all' class="btn btn-secondary rounded-pill px-3" data-filter="availability"
                data-value="All">All</button>
              <button id='ava' class="btn btn-secondary rounded-pill px-3" data-filter="availability"
                data-value="Available">Available</button>
            </div>
            <input type='hidden' value='0' id='isBorrowed' />
          </div>
          <!-- genre -->
          <div class="col-md-6 col-lg-3 mb-2">
