...
<body>
  ...
  <div class="container" style="max-width: 1140px; padding: 20px; border: none">
    ...
    <div class="event-card">
      ...
      <button type="button" class="btn btn-primary main-btn px-3 py-2">Join</button>
    ...
    <div class="event-card">
      ...
      <p class="event-date">Date: --/--/--</p>
      <button type="button" class="btn btn-primary main-btn btn px-3 py-2">Join</button>
    </div>
    ...
    <div class="container-fluid footer-grid">
      ...
      <div class="row">
        <div class="col-md-4 text-center">
          <p class="mb-0">
            &copy; 2024
            <span class="fw-bold" style="color: aquamarine">BATU Library</span>
            . All rights reserved.
          </p>
        </div>
      </div>
