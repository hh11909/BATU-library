        ...
        <form action="register2.php" method="get">
            <div class="form-row mb-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control rounded-pill" id="firstName" name="firstName" placeholder="Enter your first name" required>
                </div>
                <div class="form-group">
                    <label for="lastName" class="form-label">Last Name</label>
                    <input type="text" class="form-control rounded-pill" id="lastName" name="lastName" placeholder="Enter your last name " required>
                </div>
            </div>
            <div class="form-row mb-3">
                <div class="form-group">
            ...
            <div class="form-row mb-3">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control rounded-pill" id="studentId" name="studentId" placeholder="Enter your Student ID" required>
                </div>
            </div>
