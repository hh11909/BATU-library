...
<div class="main">
  ...
  <div class="container  my-5 pt-5">
    <header class="header ">
        <h1 class=" about-title border-0 text-center px-0 py-3 py-lg-3 ms-md-4 mb-3 pt-md-5"><i class="fa-solid fa-phone-volume pe-3 "></i>Contact Us</h1>
    </header>
  <div class="row">
    <div class="col-lg-8 align-items-center text-start">
       ...
       <div class="icons-container h-100 d-flex flex-column justify-content-center ">
        ...
        <div class="icon-label icon-contact text-center text-md-start   px-md-5 my-5">
          <a href="#" class=" me-3 fs-1 px-2 py-md-1 d-inline-block mx-md-4"><i class="fa-brands facebook fa-square-facebook"></i></a>
          <a href="#" class=" me-3 fs-1 px-2 py-md-1 d-inline-block mx-md-4"><i class="fa-brands youtube fa-youtube"></i></a>
          <a href="#" class=" me-3 fs-1 px-2 py-md-1 d-inline-block mx-md-4"><i class="fa-brands linkedin fa-linkedin"></i></a>
          <a href="#" class=" me-3 fs-1 px-2 py-md-1 d-inline-block mx-md-4"><i class="fa-brands instagram fa-instagram"></i></a>
    ...
    <div class="col-lg-4">
      ...
      <div class="form-container m-auto">
        ...
        <form action="" method="get" >
          ...
          <div class="mb-3">
            <textarea class="form-control rounded-3" id="comment" rows="9" placeholder="type your Message"></textarea>
          </div>
