     ...
     <div class="container-fluid hero-grid  d-flex align-items-center flex-column flex-md-row pe-0">
       <div  class="col-md-7 ">
         <div class="container">
             ...
             <div class=" mb-5"><h1 style="font-family: 'Poppins'; font-size: 54px; font-weight: 600; max-width: 510px; " >The University Library at BATU</h1></div>
             <div class=" mb-5"><p style="font-family: 'Quicksand'; font-size: 20px; max-width: 507px; color: #eff7ed;">BATU Library is a comprehensive university library that serves the diverse academic and research needs of the campus community</p></div>
  ...
  <!-- Discover Section -->
    ...
    <div class="container"> <!--a container to adjust the photo place :)  -->
     <div class="container discover-grid d-flex align-items-center flex-column flex-md-row m-0 p-0 ">
       <div class="col-md-5  me-5"  > 
         <img src="images/home2.jpg" alt="Library Image" style="width: auto; height: auto;" class="img-fluid"></div>
       <div  class="col-md-7 ">
       <div class="h2 mb-5"><h2 style="font-family: 'Poppins'; font-size: 58px; font-weight: 600; color: #08546d; max-width: 565px;">Discover the BATU Library</h2></div>
      <div class="p2 mb-5"><p style="font-family: 'Quicksand'; font-size: 16px; font-weight: 500; color: #08546d; max-width: 560px;">The BATU Library is a vibrant hub of intellectual activity, offering a wide range of resources and services to support the university's academic mission. From extensive print and electronic collections to state-of-the-art study spaces and collaborative areas, the library empowers students, faculty, and researchers to engage in deep learning, innovative research, and meaningful discovery</p></div> 
        <div class="list mb-5"> 
      <ul class="list-unstyled p-0" style=" max-width: 130px;">
       <li class="my-3"><a class="nav-link "style="font-family: 'Poppins'; font-size: 19px; font-weight: 500; color: #08546d;" href="Explore.php"><i class="fa-solid fa-book"></i> Collections</a></li> 
       <li class="mb-5 "><a class="nav-link "style="font-family: 'Poppins'; font-size: 19px; font-weight: 500; color: #08546d;" href="wishlist.php"><i class="fa-regular fa-heart"></i> Whishlist</a></li> 
         </ul></div>
         <div class="button2 my-5">
             <a href="Explore.php" class="btn main-btn px-4 py-3 btn-home" >Explore now</a></div>
       </div>
       </div>
      </div>
   ...
   <section class="faqs-section py-5" id="fqa"> <!-- location ==> index.php#fqa -->
     <div class="container-fluid ">
       <h2 class="text-center mb-4" style="font-family: 'Poppins'; font-size: 53px; font-weight: 600; color: #08546d;">FAQs</h2>
       <p class="text-center mb-5" style="font-family: 'Quicksand'; font-size: 21px; font-weight: 500; color: #08546d;">Find answers to your most common questions about the BATU Library.</p>
       <div class="row g-4">
         <div class="col-md-8 ">
             <div class="container">
                 <div class="row g-4 ">
                 ...
                 <div class="card faqq-card " >
                    <div class="row ">
                      <div class="col-lg-5">
                        ...
                        <p class="text-start mb-5 pb-5">Support the BATU Library's mission through charitable contributions</p>
   ...
   </section><section class="info-cards-section py-5">
     <div class="container">
       <div class="row g-4 ">
         <div class="col-md-4" >
