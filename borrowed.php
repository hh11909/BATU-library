  ...
  <!-- navigation bar end -->
    ...
    <div class="search-bar mb-4 text-center">
      <div class="input-group mt-3 w-75 w-lg-50 mx-auto">
        <input type="text" class="form-control custom-input rounded-pill py-2" placeholder=" Search Borrowed Books" aria-label="Search Wishlist">
      </div>
    </div>
    ...
    <div class="filter-sort-row text-center mt-3">
      <div class="d-flex mx-auto gap-2  w-75">
        <button class="btn btn-secondary rounded-pill" type="button" data-bs-toggle="offcanvas" data-bs-target="#filterOffcanvas" aria-controls="filterOffcanvas">
          <i class="fa-solid fa-filter" style="color: #08546d;"></i> Filter
        </button>
          <div class="dropdown">
            <button class="btn btn-secondary rounded-pill dropdown-toggle" type="button" id="sort-dropdown" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <div class="row gx-2 gy-3">
            ...
            <div class="col-md-6 col-lg-3 mb-2">
              ...
              <div class="d-flex flex-wrap gap-2">
                ...
                <button class="btn btn-secondary rounded-pill px-3" data-filter="language" data-value="English">English</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="language" data-value="Spanish">Arabic</button>
              </div>
            </div>
            <!-- availability -->
            <div class="col-md-6 col-lg-3 mb-2">
              ...
              <div class="d-flex flex-wrap gap-2">
                <button class="btn btn-secondary rounded-pill px-3" data-filter="availability" data-value="All">All</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="availability" data-value="Available">Available</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="availability" data-value="Borrowed">Borrowed</button>
              </div>
            </div>
            <!-- genre -->
            <div class="col-md-6 col-lg-3 mb-2">
              ...
              <div class="d-flex flex-wrap gap-2">
                ...
                <button class="btn btn-secondary rounded-pill px-3" data-filter="genre" data-value="engineering">Enineering</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="genre" data-value="cs">Computer Science</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="genre" data-value="ai">Artificial intelligence</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="genre" data-value="data">Data Science and analytics</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="genre" data-value="dev">Web and App Development</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="genre" data-value="net">Networking</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="genre" data-value="security">Cyber Security</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="genre" data-value="math">Mathmatics</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="genre" data-value="self-selp">Self-Help</button>
              </div>
            </div>
            <!-- category -->
            <div class="col-md-6 col-lg-3 mb-2">
              ...
              <div class="d-flex flex-wrap gap-2">
                ...
                <button class="btn btn-secondary rounded-pill px-3" data-filter="category" data-value="text-books">Text Books</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="category" data-value="most-borrowed">Most Borrowed</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="category" data-value="refrence-books">Refrence Books</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="category" data-value="recommended-students">Recommended by Students</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="category" data-value="recommended-faculty">Recommended by Faculty</button>
                <button class="btn btn-secondary rounded-pill px-3" data-filter="category" data-value="academic-research">Academic Reasearch</button>
              </div>
            </div>
          </div>
          <!-- buttons -->
      ...
      <div class="row row-cols-1 row-cols-lg-2 g-4">
          ...
          <div class="card border rounded mx-auto">
            <div class="row g-0">
              <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                <img src="wishlist-images/book1.jpg" class="img-fluid mx-auto d-block rounded" style="max-width: 150px; margin: 20px auto;" alt="Book Cover">
              </div>
        ...
        <div class="col-lg-6 mb-3">
          <div class="card border rounded mx-auto">
            <div class="row g-0">
              <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                <img src="wishlist-images/book2.jpg" class="img-fluid mx-auto d-block rounded" style="max-width: 150px; margin: 20px auto;" alt="Book Cover">
              </div>
              <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                <div class="card-body p-2">
                  <div class="mb-3 row">
      ...
      <div class="row row-cols-1 row-cols-lg-2 g-4">
        ...
        <div class="col-lg-6 mb-3">
          <div class="card border rounded mx-auto">
            <div class="row g-0">
              <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                <img src="wishlist-images/book3.jpg" class="img-fluid mx-auto d-block rounded" style="max-width: 150px; margin: 20px auto;" alt="Book Cover">
              </div>
              <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                <div class="card-body p-2">
                  <div class="mb-3 row">
        ...
        <div class="col-lg-6 mb-3">
          <div class="card border rounded mx-auto">
            <div class="row g-0">
              <div class="col-lg-4 col-md-4 col-sm-4 col-4">
                <img src="wishlist-images/book4.jpg" class="img-fluid mx-auto d-block rounded" style="max-width: 150px; margin: 20px auto;" alt="Book Cover">
              </div>
              <div class="col-lg-8 col-md-8 col-sm-8 col-8">
                <div class="card-body p-2">
                  <div class="mb-3 row">
