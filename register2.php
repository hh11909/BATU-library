          ...
          <div class="sidebar offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
            ...
            <div class="offcanvas-body d-flex flex-column flex-lg-row p-lg-0 p-4">
              <ul class="navbar-nav justify-content-lg-end align-items-center fs-6 flex-grow-1 pe-3">
                ...
                <li class="nav-item mx-2">
                  <a class="nav-link" href="">Contact</a><!--to do-->
                </li>
            ...
            <div class="row mb-3">
                <div class="col-md-4 d-flex justify-content-start align-items-center">
                    <div class=" position-relative">
                        <input type="file" id="profileImage" name="profileImage" class="d-none" accept="image/*" onchange="previewImage()">
                        <img src="https://via.placeholder.com/150" alt="Profile Image" class="profile-image" id="profileImageDisplay">
                        <a type="button" class="btn btn-main rounded-5 px-2 py-1 btn-add-img position-absolute bottom-0 end-0" onclick="document.getElementById('profileImage').click();">
                ...
                <div class="col-md-8">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control rounded-pill" id="department" name="department" placeholder="Enter your department">
                    </div>
                    <div class="form-group mb-3">
                        <label for="phoneNumber" class="form-label">Phone Number</label>
                        <input type="tel" class="form-control rounded-pill" id="phoneNumber" name="phoneNumber" placeholder="Enter your phone number">
                    </div>
                </div>
            </div>
